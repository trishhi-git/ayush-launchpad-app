  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        // Update profile with investor information
        const { error: profileError } = await supabase.from('profiles').update({
          investment_capacity: parseFloat(signUpData.investmentCapacity),
          investment_focus: signUpData.investmentFocus,
            ...
            <Tabs defaultValue="signin" className="space-y-4">
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="investment-capacity">Investment Capacity (₹)</Label>
                    <Input
