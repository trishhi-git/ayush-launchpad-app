...
export default function StartupAuth() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Welcome back!",
        description: "Successfully signed in to your startup account.",
      });

      // Role will be fetched automatically by useAuth
        ...
        <Card>
          <CardHeader className="text-center">
            <div className="mx-auto mb-4 p-3 rounded-full bg-ayush-light w-fit">
              <Building2 className="h-8 w-8 text-ayush-green" />
            </div>
            <CardTitle className="text-2xl">Startup Portal</CardTitle>
            <CardDescription>
              Access your startup registration and dashboard
            </CardDescription>
          </CardHeader>
          <CardContent>
